...
const stats = [
  { figure: "100+", label: "Farmer-members" },
  { figure: "End-to-end", label: "Traceable beans" },
  { figure: "24 hrs", label: "Farmer payment" },
];

// Thin credibility band — field-standard proof, one line, no scroll drama.
